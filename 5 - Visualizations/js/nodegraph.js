...
d3.json("data/podcast_names_list.json").then(function(graph) {
...
function selected_podcast(){
    ...
    if (all_podcasts_unique.indexOf(podcast) != -1){
        ...
        parseCSV('data/podcast_clean_papa.csv', setVar)
...
function change_word_cloud(podcast_name){
    $.getScript("js/wordcloud.js", function(){
...
function make_directed_graph(podcast, podcast_dict){
    ...
    d3.json("data/recommendations_top10.json").then(function(graph) {
            top10 = {
                'nodes': [],
                'links': []
            };
                ...
                const node = svg.append("g")
                  ...
                  .join("circle")
                    ...
                    .on("dblclick", function(d, i){
                        ...
                        $.getScript("js/stackedbarchart.js", function(){
                            make_stackedbarchart(scatterplot_list);
                            })

                        $.getScript("js/scatterplot.js", function(){
