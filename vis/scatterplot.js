...
.html("<p><b>Scatterplot</b></p><p>The below is a scatterplot created from podcast details dataset and includes only the podcasts presented in the Network Graph. It takes into account a podcast's <i>Average Rating</i>, <i>Total Duration (Hours)</i>, and <i>the number of listener reviews</i>. <br><br>The bigger the nodes appear in the plot, the more listener reviews it has. Hover over nodes for more details.<br><br> <i>This visualzation is based on the podcast you searched for.</i> </p>")



var margin = {top: 250, right: 250, bottom: 100, left: 100},
...
// Read the data from nodegraph.js
...
var color = d3.scaleOrdinal().domain([5,1]).range(d3.schemeBlues[5])
